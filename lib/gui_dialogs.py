...
class expt_select_gui(PyQt5.QtGui.QDialog):
    def __init__(self, explist, parent=None):
        ...
        layout2 = PyQt5.QtGui.QHBoxLayout()
        self.button1 = PyQt5.QtGui.QPushButton("Go to selected experiment",self)
        self.button1.clicked.connect(self.button1_function)
        self.button2 = PyQt5.QtGui.QPushButton("Set up new experiment",self)
        self.button2.clicked.connect(self.button2_function)
        self.button3 = PyQt5.QtGui.QPushButton("Find a different experiment",self)
        self.button3.clicked.connect(self.button3_function)
        self.button4 = PyQt5.QtGui.QPushButton("Cancel",self)
        ...
        #self.buttonBox = PyQt5.QtGui.QDialogButtonBox(self)
        #self.buttonBox.setOrientation(PyQt5.QtCore.Qt.Horizontal)
        #self.buttonBox.setStandardButtons(PyQt5.QtGui.QDialogButtonBox.Ok | PyQt5.QtGui.QDialogButtonBox.Cancel)
...
#
class run_cheetah_gui(PyQt5.QtGui.QDialog):
    def __init__(self, dialog_info, parent=None):
        ...
        #self.label1a = PyQt5.QtGui.QLabel()
        #self.label1a.setText("Label")
        #self.label1b = PyQt5.QtGui.QLabel()
        ...
        layout2 = PyQt5.QtGui.QHBoxLayout()
        self.label2 = PyQt5.QtGui.QLabel()
        self.label2.setText("Dataset tag: ")
        self.le = PyQt5.QtGui.QLineEdit(self)
        ...
        layout3 = PyQt5.QtGui.QHBoxLayout()
        self.label3 = PyQt5.QtGui.QLabel()
    ...
    def cheetah_dialog(dialog_info, parent=None):
        ...
        return (selection, result == PyQt5.QtGui.QDialog.Accepted)
...
#
class run_crystfel_dialog(PyQt5.QtGui.QDialog):
    def __init__(self, dialog_in, parent=None):
        ...
        self.cb3 = PyQt5.QtGui.QComboBox()
        ...
        self.label2 = PyQt5.QtGui.QLabel()
        self.cb2 = PyQt5.QtGui.QComboBox()
    ...
    def dialog_box(dialog_info, parent=None):
        ...
        return (dialog_out , result == PyQt5.QtGui.QDialog.Accepted)
