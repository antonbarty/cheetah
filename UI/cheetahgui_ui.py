...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_crystfel_cellexplorer = QtGui.QAction(MainWindow)
        self.menu_crystfel_cellexplorer.setObjectName(_fromUtf8("menu_crystfel_cellexplorer"))
        self.menu_crystfel_viewindexingresults = QtGui.QAction(MainWindow)
        self.menu_crystfel_viewindexingresults.setObjectName(_fromUtf8("menu_crystfel_viewindexingresults"))
        self.menu_crystfel_mosflmnolatt = QtGui.QAction(MainWindow)
        self.menu_crystfel_mosflmnolatt.setObjectName(_fromUtf8("menu_crystfel_mosflmnolatt"))
        self.menu_crystfel_mergestreams = QtGui.QAction(MainWindow)
        self.menu_crystfel_mergestreams.setObjectName(_fromUtf8("menu_crystfel_mergestreams"))
        self.menu_calib_darkcal = QtGui.QAction(MainWindow)
        self.menu_calib_darkcal.setObjectName(_fromUtf8("menu_calib_darkcal"))
        self.menu_calib_copydarkcal = QtGui.QAction(MainWindow)
        self.menu_calib_copydarkcal.setObjectName(_fromUtf8("menu_calib_copydarkcal"))
        self.menu_crystfel_listevents = QtGui.QAction(MainWindow)
        self.menu_crystfel_listevents.setEnabled(False)
        self.menu_crystfel_listevents.setObjectName(_fromUtf8("menu_crystfel_listevents"))
        self.menu_calib_currentdarkcal = QtGui.QAction(MainWindow)
        self.menu_calib_currentdarkcal.setObjectName(_fromUtf8("menu_calib_currentdarkcal"))
        self.menu_calib_currentbadpix = QtGui.QAction(MainWindow)
        self.menu_calib_currentbadpix.setObjectName(_fromUtf8("menu_calib_currentbadpix"))
        self.menu_calib_currentpeakmask = QtGui.QAction(MainWindow)
        self.menu_calib_currentpeakmask.setObjectName(_fromUtf8("menu_calib_currentpeakmask"))
        self.menu_calib_currentgeom = QtGui.QAction(MainWindow)
        self.menu_calib_currentgeom.setObjectName(_fromUtf8("menu_calib_currentgeom"))
        self.menu_crystfel_indexpdb = QtGui.QAction(MainWindow)
        self.menu_crystfel_indexpdb.setObjectName(_fromUtf8("menu_crystfel_indexpdb"))
        self.menu_crystfel_cellexplorer_pick = QtGui.QAction(MainWindow)
        self.menu_crystfel_cellexplorer_pick.setObjectName(_fromUtf8("menu_crystfel_cellexplorer_pick"))
        self.menu_crystfel_viewindexing_pick = QtGui.QAction(MainWindow)
        self.menu_crystfel_viewindexing_pick.setObjectName(_fromUtf8("menu_crystfel_viewindexing_pick"))
        self.menu_crystfel_indexgeopt = QtGui.QAction(MainWindow)
        self.menu_crystfel_indexgeopt.setObjectName(_fromUtf8("menu_crystfel_indexgeopt"))
        self.menu_crystfel_listfiles = QtGui.QAction(MainWindow)
        self.menu_crystfel_listfiles.setEnabled(False)
        self.menu_crystfel_listfiles.setObjectName(_fromUtf8("menu_crystfel_listfiles"))
        ...
        self.menuCrystFEL.addAction(self.menu_crystfel_indexgeopt)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_index.setText(_translate("MainWindow", "Index hits", None))
        ...
        self.menu_crystfel_cellexplorer.setText(_translate("MainWindow", "Cell explorer (selected run)", None))
        self.menu_crystfel_viewindexingresults.setText(_translate("MainWindow", "View indexing (selected run)", None))
        self.menu_crystfel_mosflmnolatt.setText(_translate("MainWindow", "Index mosflm-raw-nolatt-nocell", None))
        self.menu_crystfel_mergestreams.setText(_translate("MainWindow", "Merge stream files", None))
        self.menu_calib_darkcal.setText(_translate("MainWindow", "View darkcal", None))
        self.menu_calib_copydarkcal.setText(_translate("MainWindow", "Copy darkcal.h5 to calib/darkcal", None))
        self.menu_crystfel_listevents.setText(_translate("MainWindow", "List events", None))
        self.menu_calib_currentdarkcal.setText(_translate("MainWindow", "Set current darkcal", None))
        self.menu_calib_currentbadpix.setText(_translate("MainWindow", "Set current bad pixel mask", None))
        self.menu_calib_currentpeakmask.setText(_translate("MainWindow", "Set current analysis region mask", None))
        self.menu_calib_currentgeom.setText(_translate("MainWindow", "Set current geometry pixelmap", None))
        self.menu_crystfel_indexpdb.setText(_translate("MainWindow", "Index using unit cell info", None))
        self.menu_crystfel_cellexplorer_pick.setText(_translate("MainWindow", "Cell explorer (pick stream file)", None))
        self.menu_crystfel_viewindexing_pick.setText(_translate("MainWindow", "View indexing (pick stream file)", None))
        self.menu_crystfel_indexgeopt.setText(_translate("MainWindow", "Index for geoptimiser", None))
        self.menu_crystfel_listfiles.setText(_translate("MainWindow", "List files", None))
